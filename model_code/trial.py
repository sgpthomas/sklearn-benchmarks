...
classifier_functions = {
    "AdaBoostClassifier": AdaBoostClassifier.run, # 28
    "BernoulliNB": BernoulliNB.run, # 140
    "DecisionTreeClassifier": DecisionTreeClassifier.run, # 280
    "ExtraTreesClassifier": ExtraTreesClassifier.run, # 1120
    "GaussianNB": GaussianNB.run, # 1
    "GradientBoostingClassifier": GradientBoostingClassifier.run, # 7840
    "KNeighborsClassifier": KNeighborsClassifier.run, # 54
    "LinearSVC": LinearSVC.run, # 320
    "LogisticRegression": LogisticRegression.run, # 320
    "MultinomialNB": MultinomialNB.run, # 20
    "PassiveAggressiveClassifier": PassiveAggressiveClassifier.run, # 44
    "RandomForestClassifier": RandomForestClassifier.run, # 1120
    "SGDClassifier": SGDClassifier.run, # 201600
    "SVC": SVC.run, # 2352
    "XGBClassifier": XGBClassifier.run # 30492
}
